...
g++ -o word_building_test word_builder_tester.cpp word_builder.cpp con_cluster_list_test.cpp vow_cluster_list_test.cpp get_cluster.cpp find_indices.cpp get_flag_codes.cpp
